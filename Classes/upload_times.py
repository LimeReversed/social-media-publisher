...
def next_upload_datetime(upload_time: UploadTime, start_time: datetime.datetime | None = None) -> datetime.datetime:
    start_time = start_time or datetime.datetime.now()

    # day uses Python weekday numbering: Monday=0, ..., Sunday=6
    target_weekday = upload_time.day % 7

    target_date = next_weekday(start_time.date(), target_weekday)
